...
######## Ayudant?a 6: Viernes 20 de mayo (c?psula).
...
#### 2####
# Primer paso: crear una columna "vac?a" (todas las filas = 0)
...
#### 3####
# ?Cu?ntas provincias hay de cada tipo? Tabla de frecuencias y de proporciones
...
#### 5####
ayudantia5.reducido <- ayudantia5[, c(
  "Fertility", "nivel.educativo",
  "religion"
)]
...
tapply(
  ayudantia5.reducido$nivel.educativo,
  ayudantia5.reducido$religion,
  mean
)
