...
ggplot(starwars, aes(x = birth_year)) +
  ...
  ylim(0, 40) +
  labs(
    title = "Edad de los personajes de Star Wars",
    x = "Edad (a?os)",
...
ggplot(starwars, aes(x = birth_year, y = mass)) +
  ...
  theme_bw() +
  labs(
    title = "Correlaci?n entre edad y peso de los personajes de Star Wars",
    x = "Edad (a?os)",
    y = "Peso (kilos)"
  )
...
swiss.examination.fertility <- ggplot(swiss, aes(x = Examination, y = Fertility)) +
  ...
  theme_bw() +
  labs(
    title = "Correlaci?n entre puntaje m?ximo y fertilidad",
...
swiss.education.fertility <- ggplot(swiss, aes(x = Education, y = Fertility)) +
  ...
  theme_bw() +
  labs(
    title = "Correlaci?n entre proporci?n de la poblaci?n con b?sica completa y fertilidad",
...
swiss.education.examination <- ggplot(swiss, aes(x = Education, y = Examination)) +
  ...
  theme_bw() +
  labs(
    title = "Correlaci?n entre proporci?n de la poblaci?n con b?sica completa y calificaci?n m?xima",
    x = "Educaci?n b?sica completa (porcentaje)",
