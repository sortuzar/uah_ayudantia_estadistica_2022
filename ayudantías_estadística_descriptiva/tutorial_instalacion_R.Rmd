...
\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.8\textheight]{Imágenes/img1_1.png}\caption{R Paso 1}\label{rpaso1}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.8\textheight]{Imágenes/img1_2.png}\caption{R Paso 2}\label{rpaso2}
\end{figure}

## Descargando R base

\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.8\textheight]{Imágenes/img1_3.png}\caption{R Paso 3}\label{rpaso3}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.6\textheight]{Imágenes/img1_4.png}\caption{R Paso 4}\label{rpaso4}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.8\textheight]{Imágenes/img1_5.png}\caption{RStudio Paso 1}\label{rstudiopaso1}
\end{figure}

## Descargando RStudio

\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.8\textheight]{Imágenes/img1_6.png}\caption{RStudio Paso 2}\label{rstudiopaso2}
\end{figure}

## Descargando RStudio

\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.6\textheight]{Imágenes/img1_7.png}\caption{RStudio Paso 3}\label{rstudiopaso3}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.8\textheight]{Imágenes/img1_8.png}\caption{RStudio Paso 4}\label{rstudiopaso4}
\end{figure}
...
\begin{figure}[H]
\centering\includegraphics[keepaspectratio,width=\textwidth, height=.7\textheight]{Imágenes/img1_9.png}\caption{Usando RStudio (imagen prof. Ignacio Madero)}\label{rstudiousando1}
\end{figure}
...
\begin{columns}[t]
    \begin{column}{.65\textwidth}
      \adjincludegraphics[width=1.025\linewidth, valign=t]{Imágenes/img1_10.png}
    \end{column}
...
\begin{columns}[t]
    \begin{column}{.65\textwidth}
      \adjincludegraphics[width=1.025\linewidth, valign=t]{Imágenes/img1_11.png}
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{itemize}
...
\begin{columns}[t]
    \begin{column}{.65\textwidth}
      \adjincludegraphics[width=1.025\linewidth, valign=t]{Imágenes/img1_12.png}
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{itemize}
